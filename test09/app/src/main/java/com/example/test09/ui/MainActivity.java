...
import com.example.test09.UserClient;
import com.example.test09.adapters.ChatroomRecyclerAdapter;
import com.example.test09.models.Chatroom;
import com.example.test09.models.User;
import com.example.test09.models.UserLocation;
import com.example.test09.services.LocationService;
...
import static com.example.test09.Constants.ERROR_DIALOG_REQUEST;
import static com.example.test09.Constants.PERMISSIONS_REQUEST_ACCESS_FINE_LOCATION;
import static com.example.test09.Constants.PERMISSIONS_REQUEST_ENABLE_GPS;
...
public class MainActivity extends AppCompatActivity implements
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        String currlanguage = getLanguageEnv();
        Log.d("currlanguage",currlanguage);
        //language change
        setAppLocale(currlanguage);
...
//        this.startService(serviceIntent);
    ...
    private void newChatroomDialog(){
        ...
        builder.setTitle(R.string.chatroom_name);
        ...
        builder.setPositiveButton(R.string.action_CREATE, new DialogInterface.OnClickListener() {
            ...
            public void onClick(DialogInterface dialog, int which) {
                if(!input.getText().toString().equals("")){
                    ...
                    Toast.makeText(MainActivity.this, "R.string.chatroom_name", Toast.LENGTH_SHORT).show();
                }
            }
        });
    ...
    private void showChangeLanguageDialog(){
        final String[] listItem = {"English","中文"};
    ...
    private String getLanguageEnv() {
        ...
        Log.d("currlanguage1111",language);
        return language;
    }
