...
import com.example.test09.adapters.UserRecyclerAdapter;
...
import com.example.test09.util.MyClusterManagerRenderer;
import com.example.test09.util.ViewWeightAnimationWrapper;
...
import static com.example.test09.Constants.MAPVIEW_BUNDLE_KEY;
        ...
        if(mGoogleMap != null){
            ...
            for(UserLocation userLocation: mUserLocations){
                ...
                try{
                    ...
                    int avatar = R.drawable.man_1; // set the default avatar
                    try{
